...
export const en = {
  ...
  quote: {
    ...
    setupSectionsHint: "Which parts the finished quote includes. All off until you pick, so a quote only carries what you decided to put in it.",
