...
export const en = {
  ...
  home: {
    ...
    none: "Nothing",
    plusOtherCurrencies: "and {count} in other currencies",
  ...
  quote: {
    ...
    rateNoneForWorkHint: "Type one below and Freely will remember it for the next {work} quote, or have one researched.",
    rateSavedFor: "Your saved {work} rate.",
    rateForLabel: "{work} in {country}",
    ...
    setupSectionsHint: "Which parts the finished quote includes. Pick none and Freely chooses what fits this brief, reading your Memory for how you usually work.",
    ...
    setupSectionsNone: "Freely picks what fits",
    ...
    planning: "Reading it.",
    historyOverdue: "You have {count} invoice(s) with them already past its due date",
    historyPaidLate: "They have paid a median of {days} days after the due date",
    historyGood: "You have worked together on {count} quote(s), and they paid on time",
    historyNone: "First quote for them",
    rowSaidSomething: "You said something",
    rowWorkedOutFromBrief: "Worked out from the brief",
    rowNone: "None",
    rowImages: "{count} added",
    referencesWhen:
      "Worth adding when the brief describes a look rather than a job: a competitor you were sent, a screenshot of what they have now, a moodboard. They go on the quote so the client sees the direction you mean.",
    clientLabel: "Who is it for?",
    clientHint: "The name on the quote. Used to join this up with their other work.",
    ...
    protectionNewWhat:
      "What the price assumes, what would change it, what a cancellation costs, and who owns the work when.",
    protectionGuarded: "Something feels off",
    ...
    planPhases: "How does the work run?",
    planPhasesHint: "One piece, or stages the client can see and sign off.",
    planOnePhase: "One phase",
    planStages: "In stages",
    planStagesFor: "Are the stages where money moves?",
    planBriefAsks: "The brief asks for something different",
    planBriefAsksHint:
      "Your client described how they want this to work. That beats your usual setup, but it is your call.",
    planBriefSays: "They said: {quote}",
    planUseBrief: "Use theirs: {value}",
    planKeepMine: "Keep mine: {value}",
    moneyRateUnit: "How the price is worked out",
    moneyBilling: "Whether the number is the price",
    moneyPaymentPlan: "When you are paid",
    moneyDeposit: "How much up front",
    planStagesShape: "Just the shape of the work",
    planStagesBillable: "Payment stages",
    ...
    signalDecide: "Needs you",
    signalCheck: "Worth a look",
    signalSettled: "Settled",
    signalFromBrief: "From the brief",
    signalFromRules: "Your rules",
    signalFromHistory: "This client",
    signalFromYou: "Your call",
    planNeedsYou: "{count} need you",
    planNeedsYouOne: "1 needs you",
    planNothingPending: "Nothing needs you. Read it and write.",
    planDecisions: "Decisions",
    planContext: "What it read",
  ...
  brief: {
    ...
    sectionRestore: "Put back",
    changedOverview: "the title and price",
  ...
  track: {
    ...
    stop: "Stop",
    timeConnectCalendar: "Connect a calendar",
    timeUseRecord: "Right now this is only your own record. It never reaches an invoice and the client never sees it.",
    timeUseLearn: "Right now this is your own record, and Freely uses it to sharpen the hours on your future quotes. It never reaches an invoice and the client never sees it.",
    timeUseBilling: "Right now these hours fill invoices for this client, and you get told when they reach 80% of what you quoted.",
    timeEditUse: "Edit",
    ...
    dayEmpty: "Nothing logged.",
    logPlaceholder: "What did you do?",
    timeDelete: "Delete",
    timeSetUp: "Set up the tracker",
    timeSetUpHint: "Nothing is tracked on this engagement until you say what for.",
    timeSetUpModalHint: "Each one includes the one above it. You can change this later.",
    timeSetUpDone: "Set it up",
    modeRecord: "Just a record for me",
    modeRecordWhat: "Hours land on this project and nowhere else. Nothing reaches the client, nothing changes what you charge.",
    modeLearn: "And teach my future quotes",
    modeLearnWhat: "Once a few projects are finished, Freely knows which way your estimates usually miss and adjusts the hours on new quotes in that direction. It never says so on the quote.",
    modeBilling: "And bill this client from it",
    ...
    timelineSqueezed: "It fits, but {name} has {has} days for {needs} days of work. That part lands rougher.",
    timelineSqueezedMore: "{count} more are tight too.",
    timelineUnplacedCount: "{count} not placed yet",
    timelineUnplaced: "Not placed yet:",
    timelineNeedsDates: "Give the project a start date and this fills in.",
    viewTimeline: "Timeline",
    viewBoard: "Board",
    viewList: "List",
    boardAddTask: "Add a task",
    boardTaskName: "What needs doing",
    boardWhichDeliverable: "Which deliverable",
    boardHoursLabel: "hours",
    boardTodo: "To do",
    boardDoing: "Doing",
    boardDone: "Done",
    boardEmpty: "Nothing here.",
    boardProgress: "{done} of {total} hours done",
    boardHours: "{n}h",
    boardMoveTo: "To {column}",
    timeTitle: "Time on this",
    timeHint: "Only you see this unless you turn on billing from tracked hours.",
    timeOfQuoted: "of {hours} quoted",
    timeOver: "{percent}% over the estimate. Your quote said you would flag this before carrying on.",
    timeNearEstimate: "Close to the estimate.",
    timeStart: "Start",
    timeStop: "Stop, {length}",
    timeFromCalendar: "From my calendar",
    timeImported: "{count} blocks added.",
    timeImportedNone: "Nothing matching this project in the last fortnight.",
    timeMinutes: "Minutes",
    timeAdd: "Add",
  ...
  memory: {
    ...
    groupRules: "Ground rules",
    groupRulesHint: "How your engagements run. Every quote is written to these, and checked against them before it goes out.",
    ...
    calendarHint: "Puts your deliverable dates in your calendar and keeps them there when they move. It also lets Track read time blocks back, so a morning you booked as work becomes logged time.",
  ...
  invoices: {
    ...
    pdfOnlyIntro: "Create the invoice from these figures, then download it as a PDF and send it however you normally invoice.",
    ...
    preview: "Preview",
    previewBuilding: "Drawing the invoice...",
    previewFailed: "Could not draw the preview. The download still works.",
  ...
  rules: {
    ...
    flagFixAll: "Add all {count} for me",
  ...
  publicQuote: {
    ...
    deliverables: "Deliverables",
    milestones: "Stages",
    milestoneCloses: "Closes on: {gate}",
    milestonesBillable: "Each stage is invoiced when it is delivered.",
    milestonesShapeOnly: "These are the stages of the work. Payment follows the terms below.",
    timeline: "Timeline",
  ...
  onboarding: {
    ...
    alsoDoHint: "Optional, and as many as apply.",
  ...
  portalSignIn: {
    title: "Sign in",
    body: "This page is private. Sign in with the address you were invited on.",
    bodyNamed: "{studio} shared this page with you. Sign in with the address you were invited on.",
    email: "Your email",
    password: "Password",
    signIn: "Sign in",
    ...
    working: "One moment",
    wrong: "That didn't work. Check the address and password, or ask for a link.",
    badEmail: "That address doesn't look right.",
    tooMany: "That's a lot of tries in one minute. Wait a moment and go again.",
    sentTitle: "Check your email",
    sentBody: "If that address was invited, there is a link waiting. It works once and expires in an hour.",
  },

  portalPassword: {
    title: "Set a password",
    body: "So you can get back in without waiting for an email.",
    label: "New password",
    hint: "At least 10 characters.",
    save: "Save it",
    saved: "Saved.",
    short: "That is too short. Ten characters or more.",
    later: "Not now",
  },

  visitors: {
    title: "Who can see this page",
    hint: "Only these addresses. Everyone else gets a sign-in screen and no way past it.",
    empty: "Nobody yet. Add the people who should see it.",
    add: "Invite",
    emailLabel: "Their email",
    nameLabel: "Their name",
    remove: "Remove",
    never: "Not signed in yet",
    lastSeen: "Last opened {date}",
    hasPassword: "Password set",
    removeTitle: "Remove their access?",
    removeHint: "They are signed out everywhere immediately and the page stops loading for them.",
