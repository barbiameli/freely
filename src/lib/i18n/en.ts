...
export const en = {
  ...
  quote: {
    ...
    presetSignOffDesign: "Sign off the direction before detailed design starts",
    presetSignOffBuild: "Agree the stack and environments before any build starts",
    presetSignOffData: "Confirm data access before any analysis is scoped",
    presetSignOffWords: "Agree the angle before anything gets written",
    presetResearchFirst: "Do the discovery first and present findings before scoping the rest",
    presetSmallFirstPhase: "Keep the first phase small so it can be re-scoped after",
