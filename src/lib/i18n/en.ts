...
export const en = {
  ...
  quote: {
    ...
    rateForWhich: "Which work is this rate for?",
    rateForWhichHint: "A client is buying one kind of work, so the rate has to be for one kind of work. Pick the one this quote is mostly about.",
