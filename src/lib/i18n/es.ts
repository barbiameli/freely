...
export const es: Dictionary = {
  ...
  quote: {
    ...
    setupSectionsHint: "Que partes lleva el presupuesto. Todas apagadas hasta que elijas, asi el presupuesto solo lleva lo que decidiste ponerle.",
    ...
    setupSectionsNone: "Ninguna elegida",
