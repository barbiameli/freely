...
export const es: Dictionary = {
  ...
  clients: {
    title: "Clientes",
    subtitle: "Todos con los que has trabajado, y cómo fue.",
    empty: "Aún no hay clientes. Aparece uno la primera vez que nombras a alguien en un presupuesto.",
    quotes: "Presupuestos",
    projects: "Proyectos",
    invoices: "Facturas",
    won: "Ganados",
    answersIn: "Responde en",
    paysIn: "Paga tarde",
    overdue: "Vencidas ahora",
    days: "{n} días",
    noneYet: "Nada todavía.",
    noEmail: "Sin email",
    paid: "Pagada",
    unpaid: "Sin pagar",
    readTitle: "Qué significa para el próximo",
    readNew: "Todavía no hay datos. El presupuesto se escribirá como para un desconocido, que es lo prudente.",
    readReliable: "Paga a tiempo. Puedes presupuestar sin tanta protección.",
    readSlow: "Paga tarde. Pide un anticipo y mantén la cláusula de aceptación tácita.",
    readOverdue: "Tienen algo vencido ahora mismo. Resuélvelo antes de presupuestar más trabajo.",
    readDecisive: "Responden rápido. Un presupuesto para ellos puede ser corto.",
    readQuiet: "Tardan en responder. Pon fecha al presupuesto y di qué pasa si se pasa.",
    readLosing: "Varios presupuestos, ninguno ganado. Merece preguntar con qué lo comparan antes de escribir otro.",
    quotesCount: "{n} presupuestos",
    projectsCount: "{n} proyectos",
    invoicesCount: "{n} facturas",
  },
  ...
  track: {
    ...
    timelineSqueezed: "Cabe, pero {name} tiene {has} días para {needs} días de trabajo. Esa parte sale más en bruto.",
    timelineSqueezedMore: "Hay {count} más ajustados.",
    timelineUnplacedCount: "{count} sin colocar todavía",
    ...
    viewBoard: "Tablero",
    viewList: "Lista",
    boardAddTask: "Añadir tarea",
    boardTaskName: "Qué hay que hacer",
    boardWhichDeliverable: "Qué entregable",
    boardHoursLabel: "horas",
    boardTodo: "Por hacer",
    boardDoing: "En marcha",
    boardDone: "Hecho",
    boardEmpty: "Nada aquí.",
    boardProgress: "{done} de {total} horas hechas",
    boardHours: "{n}h",
    boardMoveTo: "A {column}",
  ...
  invoices: {
    ...
    pdfOnlyIntro: "Crea la factura a partir de estas cifras, descárgala en PDF y envíala como facturas normalmente.",
    ...
    previewBuilding: "Dibujando la factura...",
    previewFailed: "No se pudo dibujar la vista previa. La descarga sigue funcionando.",
  ...
  portalSignIn: {
    title: "Entrar",
    body: "Esta página es privada. Entra con el correo con el que te invitaron.",
    bodyNamed: "{studio} ha compartido esta página contigo. Entra con el correo con el que te invitaron.",
    email: "Tu correo",
    password: "Contraseña",
    signIn: "Entrar",
    sendLink: "Mándame un enlace",
    useLink: "Mejor mándame un enlace",
    usePassword: "Mejor uso contraseña",
    working: "Un momento",
    wrong: "No ha funcionado. Revisa el correo y la contraseña, o pide un enlace.",
    badEmail: "Ese correo no parece correcto.",
    tooMany: "Son muchos intentos en un minuto. Espera un momento y prueba otra vez.",
    sentTitle: "Mira tu correo",
    sentBody: "Si ese correo estaba invitado, tienes un enlace esperando. Funciona una vez y caduca en una hora.",
  },

  portalPassword: {
    title: "Ponte una contraseña",
    body: "Así vuelves a entrar sin esperar un correo.",
    label: "Contraseña nueva",
    hint: "Diez caracteres como mínimo.",
    save: "Guardar",
    saved: "Guardada.",
    short: "Es muy corta. Diez caracteres o más.",
    later: "Ahora no",
  },

  visitors: {
    title: "Quién puede ver esta página",
    hint: "Solo estos correos. El resto ve una pantalla de acceso y no pasa de ahí.",
    empty: "Nadie todavía. Añade a quien deba verla.",
    add: "Invitar",
    emailLabel: "Su correo",
    nameLabel: "Su nombre",
    remove: "Quitar",
    never: "Aún no ha entrado",
    lastSeen: "Abrió por última vez el {date}",
    hasPassword: "Con contraseña",
    removeTitle: "¿Quitarle el acceso?",
    removeHint: "Se le cierra la sesión en todas partes al momento y la página deja de cargarle.",
