...
export const es: Dictionary = {
  ...
  quote: {
    ...
    presetSignOffDesign: "Cerrar la dirección antes de entrar en el diseño detallado",
    presetSignOffBuild: "Acordar el stack y los entornos antes de empezar a desarrollar",
    presetSignOffData: "Confirmar el acceso a los datos antes de dimensionar el análisis",
    presetSignOffWords: "Acordar el enfoque antes de escribir nada",
    presetResearchFirst: "Hacer primero la investigación y enseñar los hallazgos antes de cerrar el resto",
    presetSmallFirstPhase: "Dejar pequeña la primera fase para poder replantear después",
