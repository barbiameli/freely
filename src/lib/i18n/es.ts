...
export const es: Dictionary = {
  ...
  memory: {
    ...
    usingWordmark: "De momento se usa el logotipo de Freely.",
    ...
    location: "Ubicación",
    currency: "Moneda",
    contextPlaceholder: "Cualquier otra cosa que convenga saber: tarifas, duración habitual de los proyectos, sectores en los que te mueves...",
  },
