...
export const es: Dictionary = {
  ...
  quote: {
    ...
    rateForWhich: "¿Para qué trabajo es esta tarifa?",
    rateForWhichHint: "Un cliente compra un tipo de trabajo, así que la tarifa tiene que ser de un tipo de trabajo. Elige el que domina este presupuesto.",
  ...
  onboarding: {
    ...
    alsoDoHint: "Opcional, y todas las que quieras. Tu tarifa se investiga para la principal de arriba.",
